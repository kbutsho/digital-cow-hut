...
const createOrder = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const buyer = yield user_model_1.User.findById(data.buyer);
    ...
    yield user_model_1.User.findOneAndUpdate({ _id: cow.seller }, { income: seller.income + cow.price });
    yield user_model_1.User.findOneAndUpdate({ _id: data.buyer }, { budget: buyer.budget - cow.price });
